"""
On-Device Habit Insight Engine
Analyzes completed and incomplete tasks across hours, task types, and contexts
to produce actionable productivity recommendations.
"""
...
class InsightEngine:
    ...
    def analyze(self) -> Dict[str, str]:
        if not self.tasks:
            return {
                ...
                "recommendation": "Start tracking daily focus blocks to activate insights."
            }
        ...
        recommendation = self._generate_recommendation(peak_hour, procrastination)
    ...
    def _detect_procrastination_trigger(self) -> str:
        # Check task types with highest incomplete ratios
    ...
    def _generate_recommendation(self, peak_hour: str, procrastination: str) -> str:
